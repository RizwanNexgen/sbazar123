...
class CustomersController extends Controller
{
    ...
    public function display()
    {
        ...
        $query->select('users.*', 'countries.countries_name');
        $query->leftJoin('countries','countries.countries_iso_code_2','=', 'users.country_code');
    ...
    public function add(Request $request)
    {
        ...
        $customerData['level_types'] = $this->Customers->user_level_types();
        $customerData['message'] = $message;
        $customerData['errorMessage'] = $errorMessage;
        $result['commonContent'] = $this->Setting->commonContent();
    ...
    public function update(Request $request){
        ...
        $user_data = array(
            ...
            'spoints'		    =>   $request->spoints,
            'ppoints'		    =>   $request->ppoints,
        );
        $customer_data = array(
