...
class ReportsController extends Controller
{
    ...
    public function minstock(Request $request)
    {
        ...
        $products = $this->reports->stock_min(20);

        $myVar = new SiteSettingController();
        //$result['currency'] = $myVar->getSetting();
        $result['commonContent'] = $myVar->Setting->commonContent();
        
        return view("admin.reports.minstock", $title)->with('result', $result)->with('products', $products);
    }
    ...
    public function minstockprint(Request $request)
    {
        ...
        $result['reports'] = $this->reports->stock_min(20);
    ...
    public function maxstock(Request $request)
    {
        ...
        $products = $this->reports->stock_max(20);
        $myVar = new SiteSettingController();
        
        $result['commonContent'] = $myVar->Setting->commonContent();
        
        return view("admin.reports.maxstock", $title)->with('result', $result)->with('products', $products);
    }
