...
class Reports extends Model
{
    ...
    public function stock_min($request)
    {
        $product = DB::table('products')
        ->leftJoin('products_description', 'products_description.products_id', '=', 'products.products_id')
        ->select('products.products_id as products_id','products.products_weight_unit as products_weight_unit','products.products_weight as products_weight','products.products_min_stock as min_level','products.products_max_stock as max_level','products.products_in_stock as stocks', 'products_description.products_name')
