...
class Shipping_method extends Model
{
    ...
    // New added by Vasim
    public function shipingMethod6(){
        $shipping_methods = DB::table('shipping_methods')->where('shipping_methods_id', '=', '6')->get();
        return $shipping_methods;
    }
    
    public function dhlMethod(){
        $shipping_methods = DB::table('shipping_dhl')->where('id', '=', '1')->first();
        return $shipping_methods;
    }

    public function shipingMethod7(){
        $shipping_methods = DB::table('shipping_methods')->where('shipping_methods_id', '=', '7')->get();
        return $shipping_methods;
    }
    
    public function dhlExpressMethod(){
        $shipping_methods = DB::table('shipping_dhl_express')->where('id', '=', '1')->first();
        return $shipping_methods;
    }
    ...
    public function dpdMethod(){
        $shipping_methods = DB::table('shipping_dpd')->where('id', '=', '1')->first();
        return $shipping_methods;
    }
    
    public function hermesMethod(){
        $shipping_methods = DB::table('shipping_hermes')->where('id', '=', '1')->first();
        return $shipping_methods;
    }
    
    public function shipingMethod8(){
        $shipping_methods = DB::table('shipping_methods')->where('shipping_methods_id', '=', '8')->get();
        return $shipping_methods;
    }
    
    public function shipingMethod9(){
        $shipping_methods = DB::table('shipping_methods')->where('shipping_methods_id', '=', '9')->get();
        return $shipping_methods;
    }
