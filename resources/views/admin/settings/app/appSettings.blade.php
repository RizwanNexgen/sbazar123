                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group android-hide">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                                        @if(!empty($result['commonContent']['setting']['app_welcome_background']))
                                                            <a href="{{asset('storage/app/welcome/'.$result['commonContent']['setting']['app_welcome_background'])}}" target="_blank">{{asset('storage/app/welcome/'.$result['commonContent']['setting']['app_welcome_background'])}}</a>
                                                        @else 
                                            ...
                                            <div class="form-group android-hide">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                                        @if(!empty($result['commonContent']['setting']['app_splash_background']))
                                                            <a href="{{asset('storage/app/splash/'.$result['commonContent']['setting']['app_splash_background'])}}" target="_blank">{{asset('storage/app/splash/'.$result['commonContent']['setting']['app_splash_background'])}}</a>
                                                        @else 
