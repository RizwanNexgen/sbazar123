...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Flash Deals <small>Add Products...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/flash-deals/display')}}"><i class="fa fa-industry"></i> Flash Deals</a></li>
                                            ...
                                            <table id="myTable" class="table table-bordered table-striped">
                                                ...
                                                @if(count($list)>0)
                                                    ...
                                                    <tr id="tr_{{ $o->products_id }}">
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" onClick="addFlashDealsProduct({{$o->products_id}})" class="btn btn-success btn-sm">Add</a>                                                            
                                                        </td>
                                                    </tr>
                                                    @endforeach                                
                                                @endif
    ...
    <script type="text/javascript">
        ...
        function addFlashDealsProduct(product_id)
        {
            $.ajax({
                url:'{{url("admin/flash-deals/add_product")}}',
