<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        ?>
        <li class="treeview {{ Request::is('admin/reviews/display') ? 'active' : '' }} {{ Request::is('admin/combos/*') ? 'active' : '' }} {{ Request::is('admin/super-deals/*') ? 'active' : '' }} {{ Request::is('admin/flash-deals/*') ? 'active' : '' }} {{ Request::is('admin/bundles/*') ? 'active' : '' }} {{ Request::is('admin/manufacturers/display') ? 'active' : '' }} {{ Request::is('admin/manufacturers/add') ? 'active' : '' }} {{ Request::is('admin/manufacturers/edit/*') ? 'active' : '' }} {{ Request::is('admin/units') ? 'active' : '' }} {{ Request::is('admin/addunit') ? 'active' : '' }} {{ Request::is('admin/editunit/*') ? 'active' : '' }} {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/display') ? 'active' : '' }}  {{ Request::is('admin/products/attributes/add') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} {{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }} {{ Request::is('admin/products/inventory/display') ? 'active' : '' }}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->manufacturer_view == 1)
              ...
              <li class="{{ Request::is('admin/hotcats/display') ? 'active' : '' }} {{ Request::is('admin/hotcats/add') ? 'active' : '' }} {{ Request::is('admin/hotcats/edit/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/hotcats/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_hotcat') }}</a></li>
            @endif
            @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->categories_view == 1)
              ...
              <li class="{{ Request::is('admin/bundles/display') ? 'active' : '' }} {{ Request::is('admin/bundles/add') ? 'active' : '' }} {{ Request::is('admin/bundles/edit/*') ? 'active' : '' }} {{ Request::is('admin/bundles/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/bundles/display')}}"><i class="fa fa-circle-o"></i> Bundles</a></li>
              <li class="{{ Request::is('admin/combos/display') ? 'active' : '' }} {{ Request::is('admin/combos/add') ? 'active' : '' }} {{ Request::is('admin/combos/edit/*') ? 'active' : '' }} {{ Request::is('admin/combos/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/combos/display')}}"><i class="fa fa-circle-o"></i> Combos</a></li>
              <li class="{{ Request::is('admin/packages/display') ? 'active' : '' }} {{ Request::is('admin/packages/add') ? 'active' : '' }} {{ Request::is('admin/packages/edit/*') ? 'active' : '' }} {{ Request::is('admin/packages/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/packages/display')}}"><i class="fa fa-circle-o"></i> Collections</a></li>
            @endif
            ...
            @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view == 1)
              ...
              <li class="{{ Request::is('admin/super-deals/display') ? 'active' : '' }} {{ Request::is('admin/super-deals/add') ? 'active' : '' }} {{ Request::is('admin/super-deals/edit/*') ? 'active' : '' }} {{ Request::is('admin/super-deals/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/super-deals/display')}}"><i class="fa fa-circle-o"></i> Super Deals</a></li>
              <li class="{{ Request::is('admin/flash-deals/display') ? 'active' : '' }} {{ Request::is('admin/flash-deals/add') ? 'active' : '' }} {{ Request::is('admin/flash-deals/edit/*') ? 'active' : '' }} {{ Request::is('admin/flash-deals/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/flash-deals/display')}}"><i class="fa fa-circle-o"></i> Flash Deals</a></li>
        ...
        ?>
        <li class="treeview {{ Request::is('admin/memberships/display') ? 'active' : '' }}  {{ Request::is('admin/memberships/add') ? 'active' : '' }}  {{ Request::is('admin/memberships/edit/*') ? 'active' : '' }} {{ Request::is('admin/customers/display') ? 'active' : '' }}  {{ Request::is('admin/customers/add') ? 'active' : '' }}  {{ Request::is('admin/customers/edit/*') ? 'active' : '' }} {{ Request::is('admin/customers/address/display/*') ? 'active' : '' }} {{ Request::is('admin/customers/filter') ? 'active' : '' }} ">
          <a href="">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_customers') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              
            <li class="{{ Request::is('admin/customers/display') ? 'active' : '' }} {{ Request::is('admin/customers/add') ? 'active' : '' }}  {{ Request::is('admin/customers/edit/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/customers/display')}}"><i class="fa fa-circle-o"></i>Customers List</a></li>
            <li class="{{ Request::is('admin/memberships/display') ? 'active' : '' }} {{ Request::is('admin/memberships/add') ? 'active' : '' }}  {{ Request::is('admin/memberships/edit/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/memberships/display')}}"><i class="fa fa-circle-o"></i>Users Level</a></li>
        ...
        <?php
          if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view ==1){
        ?>
        <li class="treeview {{ Request::is('admin/points_setting/display') ? 'active' : '' }} {{ Request::is('admin/editpoints_setting/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/points_setting/display')}}" ><i class="fa fa-tablet" aria-hidden="true"></i> <span>Points Setting</span></a>
        </li>
        <?php } ?>
        <!--Point Setting Menu-->
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/newsletters/display') ? 'active' : '' }} {{ Request::is('admin/editnewsletters/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/newsletters/display')}}" ><i class="fa fa-envelope" aria-hidden="true"></i> <span>Newsletters</span></a>
        </li>
      <?php } ?>
      <?php
  ...
  <span> {{ trans('labels.link_app_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview {{ Request::is('admin/faq/*') ? 'active' : '' }} {{ Request::is('admin/faq-cat/*') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/faq/display') ? 'active' : '' }} {{ Request::is('admin/faq/add') ? 'active' : '' }} {{ Request::is('admin/faq/edit/*') ? 'active' : '' }} {{ Request::is('admin/faq/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/faq/display')}}"><i class="fa fa-circle-o"></i> Faq </a></li>
                  <li class="{{ Request::is('admin/faq-cat/display') ? 'active' : '' }} {{ Request::is('admin/faq-cat/add') ? 'active' : '' }} {{ Request::is('admin/faq-cat/edit/*') ? 'active' : '' }} {{ Request::is('admin/faq-cat/filter') ? 'active' : '' }}"><a href="{{ URL::to('admin/faq-cat/display')}}"><i class="fa fa-circle-o"></i> Faq Category</a></li>
              </ul>
            </li>
