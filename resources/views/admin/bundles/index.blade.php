                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/bundles/add') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if(count($list)>0)
                                            ...
                                            <tr>
                                                <td>{{ $o->id }}</td>
                                                <td>{{ $o->bundle_info()->bundle_title }}</td>
                                                
                                                <td>@if($o->bundle_type=='1') Price @elseif($o->bundle_type=='2') Point @endif</td> 
                                                <td>{{ $o->discount }}%</td>                                               
                                                <td>
                                                      @if($o->status==1)
                                                ...
                                                <td><a href="javascript:void(0)" onClick="$('#products_{{$o->id}}').toggle();">{{$o->bundle_products()->count()}}</a></td>
                                                <td>
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ URL::to('admin/bundles/edit/'.$o->id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Delete" onClick="return confirm('Sure to delete?')" href="{{url('admin/bundles/delete/'.$o->id)}}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>

                                            @if($o->bundle_products()->count()>0)
                                                    ...
                                                    <div class="card">
                                                        <table class="table">
                                                            ...
                                                            @foreach($o->products as $p)    
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="15%" style="vertical-align:middle;">
                                                                        <form class="form-inline" method="POST" action="{{url('admin/bundles/update_bundle_quantity')}}">
                                                                            @csrf
                                                                            <input type="hidden" name="bundle_product_id" value="{{$p->bundle_product_id}}" />
                                                                    ...
                                                                    <td width="10%" style="vertical-align:middle;">
                                                                        <a class="btn btn-sm btn-danger" href="{{url('admin/bundles/delete_bundle_product/'.$p->bundle_product_id)}}" onClick="return confirm('Sure to delete?')">Remove</a>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;</td>
                                                                <td style="vertical-align:middle;"><strong>{{$increment}} pts ({{$o->discount}}%)</strong></td>                                                                
                                                                <td style="vertical-align:middle;" colspan="2">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="vertical-align:middle; text-align:right;" colspan="6"><strong>Bundle Total:</strong></td>                                                                
                                                                <td style="vertical-align:middle;"><strong>${{$total_price}}</strong></td>
                                                                <td style="vertical-align:middle;"><strong>{{$total_points+$increment}} pts</strong></td>
                                                                <td style="vertical-align:middle;" colspan="2">&nbsp;</td>
                                                            </tr>
                                                            @endif
                                            ...
                                            <tr>
                                                <td colspan="7">
                                                    <p style="color:#CCC;">No products in {{ $o->bundle_info()->bundle_title }} bundle</p>
                                                </td>
                                            </tr>
                                            @endif
