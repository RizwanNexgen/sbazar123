                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="bundle_type" class="form-control">
                                                    <option value="1" @if(old('bundle_type')==1) selected @endif>Price</option>
                                                    <option value="2" @if(old('bundle_type')==2) selected @endif>Point</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Status</label>
                                                <select name="bundle_type" class="form-control">
                                                    ...
                                                    <option value="0" @if(old('status')==2) selected @endif>Inactive</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div id="msd_fields" style="display:none;">
                                                <div class="row">
                                                    @foreach($user_level_types as $level)
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label>{{$level->level_title}}</label>
                                                                <input type="text" class="form-control" name="level_discount_{{$level->id}}" value="" />
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane @if($key==0) active @endif" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="bundle_title_{{$languages->languages_id}}" value="" />
                                                                </div>
                                                                 <div class="form-group">
                                                                    
                                                                    <div class="col-sm-10 col-md-8">
                                                                       <label>Bundle Description</label>
                                                                        <textarea id="editor<?=$languages->languages_id?>" name="bundle_tos_{{$languages->languages_id}}" class="form-control" rows="5"></textarea>
