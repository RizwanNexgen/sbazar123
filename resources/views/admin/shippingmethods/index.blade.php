                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                        ...
                                        @foreach ($result['shipping_methods'] as $key=>$shipping_methods)
                                            <tr>
                                                ...
                                                @if($shipping_methods->methods_type_link=='shippingDhl')
                                                    <td>---</td>
                                                    <td>
                                                        @if($shipping_methods->status==0)
                                                            <span class="label label-warning">
                                                    ...
                                                    <td><a href="{{ $shipping_methods->methods_type_link }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                @endif

                                                @if($shipping_methods->methods_type_link=='shippingDhlExpress')
                                                    <td>---</td>
                                                    <td>
                                                        @if($shipping_methods->status==0)
                                                            <span class="label label-warning">
                                                ...
                                                @if($shipping_methods->methods_type_link=='shippingDpd')
                                                    <td>{{ $result['dpdMethod']->currency }}{{ $result['dpdMethod']->standard_shipping_price }}</td>
                                                    <td>
                                                        @if($shipping_methods->status==0)
                                                            <span class="label label-warning">
                                                            	{{ trans('labels.InActive') }}
                                                    ...
                                                    <td><a href="{{ $shipping_methods->methods_type_link }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                    <td> <a href="{{ URL::to('admin/shippingmethods/dpdCountries/')}}" class="badge bg-light-blue">More options</a></td>
                                                @endif
                                                
                                                @if($shipping_methods->methods_type_link=='shippingHermes')
                                                    <td>{{ $result['hermesMethod']->currency }}{{ $result['hermesMethod']->standard_shipping_price }}</td>
                                                    <td>
                                                        @if($shipping_methods->status==0)
                                                            <span class="label label-warning">
                                                            	{{ trans('labels.InActive') }}
                                                    ...
                                                    <td><a href="{{ $shipping_methods->methods_type_link }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                    <td> <a href="{{ URL::to('admin/shippingmethods/hermesCountries/')}}" class="badge bg-light-blue">More options</a></td>
                                                @endif
