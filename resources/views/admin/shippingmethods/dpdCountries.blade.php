...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> DPD <small>More options...</small> </h1>
            <ol class="breadcrumb">
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <form action="{{url('admin/shippingmethods/updateDpdCountries')}}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                ...
                                                @foreach($result['dpd_countries'] as $o)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <a class="btn btn-danger" href="{{url('admin/shippingmethods/dpdCountries/delete/'.$o->id)}}" onClick="return confirm('Sure to delete?')">&times</a>
                                                    </div>
                                                </div>
                                                @endforeach
