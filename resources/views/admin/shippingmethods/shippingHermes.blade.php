                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        <!-- form start -->
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/shippingmethods/updateShippingHermes', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id',  $result['hermes']->id, array('class'=>'form-control', 'id'=>'id'))!!}
                                            ...
                                            @endforeach
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Standard Shipping Price</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('standard_shipping_price',  $result['hermes']->standard_shipping_price, array('class'=>'form-control', 'id'=>'standard_shipping_price'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('currency',  $result['hermes']->currency, array('class'=>'form-control', 'id'=>'currency'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
