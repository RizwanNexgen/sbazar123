    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">DHL Express</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">DHL Express</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        <!-- form start -->
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/shippingmethods/updateShippingDhlExpress', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id',  $result['dhl_express']->id, array('class'=>'form-control', 'id'=>'id'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('min_price_for_free',  $result['dhl_express']->min_price_for_free, array('class'=>'form-control', 'id'=>'min_price_for_free'))!!}
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Extra Fee</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('extra_fee',  $result['dhl_express']->extra_fee, array('class'=>'form-control', 'id'=>'extra_fee'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    Extra fee charge
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('currency',  $result['dhl_express']->currency, array('class'=>'form-control', 'id'=>'currency'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select id="country_includes" name="country_includes[]" class="form-control select2" multiple>
                                                        ...
                                                        <option value="{{$country->countries_iso_code_2}}" @if(@in_array($country->countries_iso_code_2, explode(',', $result['dhl_express']->country_includes))) selected @endif>{{$country->countries_name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
