...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Edit Newsletter') }} <small>{{ trans('labels.Edit Newsletter') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/newsletters/display')}}"><i class="fa fa-gears"></i> {{ trans('labels.Newsletters') }}</a></li>
            <li class="active">{{ trans('labels.Edit Newsletter') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.Edit Newsletter') }} </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
