                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Name') }}@if($languages->code=='en') <span style="color:red;">*</span> @endif ({{ $languages->name }})</label>
                                            <div class="col-sm-10 col-md-4">
                                                <input name="categoryName_<?=$languages->languages_id?>" class="form-control @if($languages->code=='en') field-validate @endif">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
