                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@sortablelink('user_level_id', 'Level') </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $listingCustomers->first_name }}</td>
                                            <td>{{ $listingCustomers->last_name }}</td>
                                            <td style="text-transform: lowercase">{{ $listingCustomers->email }}</td>
                                            <td>{{ $listingCustomers->user_level_id }}</td>
                                            <td>                                               
                                                <strong>{{ trans('labels.Phone') }}: </strong> {{ $listingCustomers->phone }} 
                                                <br>
                                                <strong>City: </strong> {{ $listingCustomers->city }}
                                                <br>
                                                <strong>Country: </strong> {{ $listingCustomers->countries_name }}
                                                <br>
                                                <strong>Referral ID: </strong> {{ $listingCustomers->referral_id }}
                                                <br>
                                                <strong>Premium Points: </strong> {{ $listingCustomers->ppoints }} 
                                                <br>
                                                <strong>Status: </strong> @if($listingCustomers->status==1) Active @else Inactive @endif
                                            </td>
