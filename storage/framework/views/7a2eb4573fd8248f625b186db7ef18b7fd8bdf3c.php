                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('user_level_id', 'Level'));?> </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($listingCustomers->first_name); ?></td>
                                            <td><?php echo e($listingCustomers->last_name); ?></td>
                                            <td style="text-transform: lowercase"><?php echo e($listingCustomers->email); ?></td>
                                            <td><?php echo e($listingCustomers->user_level_id); ?></td>
                                            <td>                                               
                                                <strong><?php echo e(trans('labels.Phone')); ?>: </strong> <?php echo e($listingCustomers->phone); ?> 
                                                <br>
                                                <strong>City: </strong> <?php echo e($listingCustomers->city); ?>

                                                <br>
                                                <strong>Country: </strong> <?php echo e($listingCustomers->countries_name); ?>

                                                <br>
                                                <strong>Referral ID: </strong> <?php echo e($listingCustomers->referral_id); ?>

                                                <br>
                                                <strong>Premium Points: </strong> <?php echo e($listingCustomers->ppoints); ?> 
                                                <br>
                                                <strong>Status: </strong> <?php if($listingCustomers->status==1): ?> Active <?php else: ?> Inactive <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/customers/index.blade.php ENDPATH**/ ?>