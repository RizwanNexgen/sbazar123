<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> <?php echo e(trans('labels.Hotcat')); ?> <small><?php echo e(trans('labels.Hotcat')); ?>...</small> </h1>
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo e(trans('labels.AddHotcat')); ?></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><?php echo e(trans('labels.AddNewHotcat')); ?> </h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        <!-- form start -->
                                        <div class="box-body">
                                            <?php echo Form::open(array('url' =>'admin/hotcats/add', 'method'=>'post', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('color_code',  '', array('class'=>'form-control  field-validate', 'id'=>'color_code'), value(old('color_code'))); ?>
                                            ...
                                            <div class="form-group" id="imageselected">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <div id="imageselected">
                                                        <?php echo Form::button(trans('labels.Add Image'), array('id'=>'newImage','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#Modalhotcated" )); ?>
                                            ...
                                            <div class="form-group" id="imageIcone">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <div id="imageselected">
                                                    <?php echo Form::button(trans('labels.Add Icon'), array('id'=>'newIcon','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#ModalhotcatedICone" )); ?>
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        ...
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                            <?php echo e(trans('labels.EnterHotcatDetailIn')); ?> <?php echo e($languages->name); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/hotcats/add.blade.php ENDPATH**/ ?>