...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.Max Stock Report')); ?> <small><?php echo e(trans('labels.Max Stock Report')); ?>...</small> </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
      <li class="active"><?php echo e(trans('labels.Max Stock Report')); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.Max Stock Report')); ?> </h3>

            <div class="box-tools pull-right">
              <form action="<?php echo e(URL::to('admin/maxstockprint')); ?>" target="_blank">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('labels.Max Level')); ?></th>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/reports/maxstock.blade.php ENDPATH**/ ?>