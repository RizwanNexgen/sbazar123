                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                   ...
                   <tbody>
                    ...
                    <?php $__currentLoopData = $result['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                   
                      <tr>
                          <td><?php echo e($r->products_id); ?></td>  
                          <td><?php echo e($r->products_name . ' - ' . $r->products_weight . ' ' . $r->products_weight_unit); ?></td>    
                          <td><?php echo e($r->products_in_stock); ?></td>    
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/reports/outofstock.blade.php ENDPATH**/ ?>