                            ...
                            <div class="row">
                                ...
                                <?php echo e(trans('labels.OnesignalAppidText')); ?></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text('onesignal_sender_id',  $result['commonContent']['setting']['onesignal_app_id'], array('class'=>'form-control', 'id'=>'onesignal_sender_id')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/settings/general/pushNotification.blade.php ENDPATH**/ ?>