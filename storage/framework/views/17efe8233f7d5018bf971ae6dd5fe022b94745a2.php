<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        ?>
        <li class="treeview <?php echo e(Request::is('admin/reviews/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/combos/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/super-deals/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/flash-deals/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/bundles/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/manufacturers/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/manufacturers/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/manufacturers/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/units') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addunit') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editunit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editattributes/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/attributes/display') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/products/attributes/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/attributes/add/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addinventory/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addproductimages/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/filter') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/inventory/display') ? 'active' : ''); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <?php if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->manufacturer_view == 1): ?>
              ...
              <li class="<?php echo e(Request::is('admin/hotcats/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/hotcats/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/hotcats/edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/hotcats/display')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.link_hotcat')); ?></a></li>
            <?php endif; ?>
            <?php if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->categories_view == 1): ?>
              ...
              <li class="<?php echo e(Request::is('admin/bundles/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/bundles/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/bundles/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/bundles/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/bundles/display')); ?>"><i class="fa fa-circle-o"></i> Bundles</a></li>
              <li class="<?php echo e(Request::is('admin/combos/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/combos/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/combos/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/combos/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/combos/display')); ?>"><i class="fa fa-circle-o"></i> Combos</a></li>
              <li class="<?php echo e(Request::is('admin/packages/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/packages/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/packages/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/packages/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/packages/display')); ?>"><i class="fa fa-circle-o"></i> Collections</a></li>
            <?php endif; ?>
            ...
            <?php if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view == 1): ?>
              ...
              <li class="<?php echo e(Request::is('admin/super-deals/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/super-deals/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/super-deals/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/super-deals/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/super-deals/display')); ?>"><i class="fa fa-circle-o"></i> Super Deals</a></li>
              <li class="<?php echo e(Request::is('admin/flash-deals/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/flash-deals/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/flash-deals/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/flash-deals/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/flash-deals/display')); ?>"><i class="fa fa-circle-o"></i> Flash Deals</a></li>
        ...
        ?>
        <li class="treeview <?php echo e(Request::is('admin/memberships/display') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/memberships/add') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/memberships/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/customers/display') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/customers/add') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/customers/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/customers/address/display/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/customers/filter') ? 'active' : ''); ?> ">
          <a href="">
            <i class="fa fa-users" aria-hidden="true"></i> <span><?php echo e(trans('labels.link_customers')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              
            <li class="<?php echo e(Request::is('admin/customers/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/customers/add') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/customers/edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/customers/display')); ?>"><i class="fa fa-circle-o"></i>Customers List</a></li>
            <li class="<?php echo e(Request::is('admin/memberships/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/memberships/add') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/memberships/edit/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/memberships/display')); ?>"><i class="fa fa-circle-o"></i>Users Level</a></li>
        ...
        ?>
        <li class="treeview <?php echo e(Request::is('admin/points_setting/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editpoints_setting/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/points_setting/display')); ?>" ><i class="fa fa-tablet" aria-hidden="true"></i> <span>Points Setting</span></a>
        </li>
        <?php } ?>
        <!--Point Setting Menu-->
      ...
      ?>
        ...
        <li class="treeview <?php echo e(Request::is('admin/newsletters/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editnewsletters/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/newsletters/display')); ?>" ><i class="fa fa-envelope" aria-hidden="true"></i> <span>Newsletters</span></a>
        </li>
      <?php } ?>
      <?php
  ...
  <span> <?php echo e(trans('labels.link_app_settings')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview <?php echo e(Request::is('admin/faq/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq-cat/*') ? 'active' : ''); ?>">
              <a href="#">
                <i class="fa fa-circle-o"></i> <span>FAQ</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li class="<?php echo e(Request::is('admin/faq/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/faq/display')); ?>"><i class="fa fa-circle-o"></i> Faq </a></li>
                  <li class="<?php echo e(Request::is('admin/faq-cat/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq-cat/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq-cat/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq-cat/filter') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/faq-cat/display')); ?>"><i class="fa fa-circle-o"></i> Faq Category</a></li>
              </ul>
            </li>
...
<?php /**PATH /home/pidesqfm/square.pidetutransporte.com/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>