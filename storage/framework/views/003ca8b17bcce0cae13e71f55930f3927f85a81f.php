<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Bundles <small>Add Bundle...</small> </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add new bundle</h3>
                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="bundle_type" class="form-control">
                                                    <option value="1" <?php if(old('bundle_type')==1): ?> selected <?php endif; ?>>Price</option>
                                                    <option value="2" <?php if(old('bundle_type')==2): ?> selected <?php endif; ?>>Point</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Status</label>
                                                <select name="bundle_type" class="form-control">
                                                    ...
                                                    <option value="0" <?php if(old('status')==2): ?> selected <?php endif; ?>>Inactive</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Points</label>
                                                <input type="text" class="form-control" name="points" value="<?php echo e(old('points')); ?>" />
                                            </div>
                                            ...
                                            <div id="msd_fields" style="display:none;">
                                                <div class="row">
                                                    <?php $__currentLoopData = $user_level_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label><?php echo e($level->level_title); ?></label>
                                                                <input type="text" class="form-control" name="level_discount_<?php echo e($level->id); ?>" value="" />
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="bundle_title_<?php echo e($languages->languages_id); ?>" value="" />
                                                                </div>
                                                                 <div class="form-group">
                                                                    
                                                                    <div class="col-sm-10 col-md-8">
                                                                       <label>Bundle Description</label>
                                                                        <textarea id="editor<?=$languages->languages_id?>" name="bundle_tos_<?php echo e($languages->languages_id); ?>" class="form-control" rows="5"></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/bundles/add.blade.php ENDPATH**/ ?>