<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> <?php echo e(trans('labels.Hotcat')); ?>  <small><?php echo e(trans('labels.EditCurrentHotcat')); ?>...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
                <li><a href="<?php echo e(URL::to('admin/hotcats/display')); ?>"><i class="fa fa-industry"></i> <?php echo e(trans('labels.Hotcat')); ?></a></li>
                <li class="active"><?php echo e(trans('labels.EditHotcat')); ?></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><?php echo e(trans('labels.EditHotcatInfo')); ?> </h3>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/hotcats/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>

                                            <?php echo Form::hidden('id',  $editHotcat->id , array('class'=>'form-control', 'id'=>'id')); ?>

                                            <?php echo Form::hidden('oldImage',  $editHotcat->header_image , array('id'=>'oldImage')); ?>

                                            <?php echo Form::hidden('oldIcon', $editHotcat->logo_image , array('id'=>'oldIcon')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('name',  $editHotcat->name , array('class'=>'form-control field-validate', 'id'=>'name'), value(old('name'))); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.HotcatNameExample')); ?></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('color_code',  $editHotcat->color_code, array('class'=>'form-control  field-validate', 'id'=>'color_code'), value(old('color_code'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" name="hotcats_status">
                                                        <option <?php echo e(($editHotcat->status == 1) ? "selected" : ""); ?> value="1"><?php echo e(trans('labels.Active')); ?></option>
                                                        <option <?php echo e(($editHotcat->status == 0) ? "selected" : ""); ?> value="0"><?php echo e(trans('labels.Inactive')); ?></option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="hidden" name="old_slug" value="<?php echo e($editHotcat->slug); ?>">
                                                    <input type="text" name="slug" class="form-control field-validate" value="<?php echo e($editHotcat->slug); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <?php echo Form::button(trans('labels.Add Image'), array('id'=>'newImage','class'=>"btn btn-primary ", 'data-toggle'=>"modal", 'data-target'=>"#Modalhotcated" )); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <img src="<?php echo e(asset($editHotcat->header_path)); ?>" alt="" width=" 100px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <div id="imageselected">
                                                        <?php echo Form::button(trans('labels.Add Icon'), array('id'=>'newIcon','class'=>"btn btn-primary ", 'data-toggle'=>"modal", 'data-target'=>"#ModalhotcatedICone" )); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.OldImage')); ?></span>
                                                    <br>
                                                    <img src="<?php echo e(asset($editHotcat->logo_path)); ?>" alt="" width=" 100px">
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <textarea id="editor<?=$languages->languages_id?>" name="brand_description_<?=$languages->languages_id?>" class="form-control" rows="5"><?php echo e($editHotcat->infos[$languages->languages_id]->hotcats_desc); ?></textarea>
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="<?php echo e(URL::to('admin/hotcats/display')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                                            </div>
                                            <!-- /.box-footer -->
                                            <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/hotcats/edit.blade.php ENDPATH**/ ?>