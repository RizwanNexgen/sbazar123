                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <!-- /.box-header -->
                                        <!-- form start -->
                                        <div class="box-body">
                                            <?php echo Form::open(array('url' =>'admin/memberships/update', 'method'=>'post', 'class' => 'form-horizontal form-validate ', 'enctype'=>'multipart/form-data')); ?>

                                            <?php echo Form::hidden('id',  $editMembership->id , array('class'=>'form-control', 'id'=>'id')); ?>

                                            <?php echo Form::hidden('oldImage',  $editMembership->membership_image_id , array('id'=>'oldImage')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('name',  $editMembership->name, array('class'=>'form-control  field-validate', 'id'=>'name'), value(old('name'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <img src="<?php echo e(asset($editMembership->logo_path)); ?>" alt="" width=" 100px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5 col-md-2">
                                                    <?php echo Form::number('membership_points_from',  $editMembership->point_from, array('class'=>'form-control  field-validate', 'id'=>'membership_points_from'), value(old('membership_points_from'))); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Points From</span>
                                                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                                </div>
                                                <div class="col-sm-5 col-md-2">
                                                    <?php echo Form::number('membership_points_to',  $editMembership->point_to, array('class'=>'form-control  field-validate', 'id'=>'membership_points_to'), value(old('membership_points_to'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::number('membership_discount_percentage',  $editMembership->discount, array('class'=>'form-control  field-validate', 'id'=>'membership_discount_percentage'), value(old('membership_discount_percentage'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::number('membership_cap_value',  $editMembership->cap_val, array('class'=>'form-control  field-validate', 'id'=>'membership_cap_value'), value(old('membership_cap_value'))); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select class="form-control" id="membership_has_validity" name="membership_has_validity">
                                                        <option <?php echo e(($editMembership->has_validity == 1) ? "selected" : ""); ?> value="1">Yes</option>
                                                        <option <?php echo e(($editMembership->has_validity == 0) ? "selected" : ""); ?> value="0">No</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <label for="membership_valid_till" id="membership_valid_till_label" class="col-sm-2 col-md-3 control-label">Membership Valid Till <?php echo ($editMembership->has_validity == 1) ? "<span style='color:red;'>*</span>" : ""; ?></label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input <?php echo e(($editMembership->has_validity == 0) ? "disabled" : ""); ?> autocomplete="OFF" type="text" class="form-control <?php echo e(($editMembership->has_validity == 1) ? "field-validate" : ""); ?> form_datetime" id="membership_valid_till" name="membership_valid_till" value="<?php echo e(($editMembership->has_validity == 1) ? $editMembership->valid_till : ""); ?>" />
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                        ...
                                                                        <textarea id="editor<?=$languages->languages_id?>" name="benifit_description_<?=$languages->languages_id?>" class="form-control" rows="5"><?php echo e($editMembership->infos[$languages->languages_id]->membership_description); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/Membership/edit.blade.php ENDPATH**/ ?>