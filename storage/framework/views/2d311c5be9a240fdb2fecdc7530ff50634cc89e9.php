                                ...
                                <form  name='registration'  class="registration" method="get">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        <select class="form-control" name="product_type">
                                            ...
                                            <option value="Simple" <?php if(Request('product_type')=='Simple'): ?> selected <?php endif; ?>>Simple</option>
                                            <option value="Variable" <?php if(Request('product_type')=='Variable'): ?> selected <?php endif; ?>>Variable</option>
                                        </select>
                                        <select class="form-control" name="brand_id">
                                            <option value="">Brand</option>
                                            <?php $__currentLoopData = $results['brand_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <select class="form-control" name="unit_id">
                                            ...
                                            <?php $__currentLoopData = $results['units']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($unit->units_name); ?>" <?php if(Request('unit_id')==$unit->units_name): ?> selected <?php endif; ?>><?php echo e($unit->units_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        ...
                                        <?php if(!empty(Request('_token'))): ?>  
                                            <a class="btn btn-danger " href="<?php echo e(url('admin/products/display')); ?>">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                        ...
                                        <?php if(count($results['products'])>0): ?>
                                            ...
                                            <?php $__currentLoopData = $resultsProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo e(asset($product->path)); ?>" alt="" height="100px"></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php endif; ?>
                                                        <br>
                                                        <strong>Product Unique ID: <?php echo e($product->products_sku); ?></strong>   
                                                        <br>
                                                        <?php if(!empty($product->manufacturer_name)): ?>
                                                            <strong>Brand:</strong> <?php echo e($product->manufacturer_name); ?><br>
                                                        <?php endif; ?>
                                                        <?php if(!empty($product->products_points)): ?>
                                                            <strong>Points:</strong> <?php echo e($product->products_points); ?><br>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(!empty($result['commonContent']['currency']->symbol_left)): ?> <?php echo e($result['commonContent']['currency']->symbol_left); ?> <?php endif; ?> <?php echo e($product->products_price_market); ?> <?php if(!empty($result['commonContent']['currency']->symbol_right)): ?> <?php echo e($result['commonContent']['currency']->symbol_right); ?> <?php endif; ?>
                                                        <br>
                                ...
                                <div class="col-xs-12 col-md-6 text-right">
                                   <?php echo e($results['products']->appends([
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/products/index.blade.php ENDPATH**/ ?>