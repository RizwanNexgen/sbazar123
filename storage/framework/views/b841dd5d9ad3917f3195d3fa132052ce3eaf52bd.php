    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/bundles/display')); ?>"><i class="fa fa-industry"></i> Collections</a></li>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" class="form-control">
                                                    ...
                                                    <option value="<?php echo e($package->id); ?>"><?php echo e($package->package_info()->package_title); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                                                                      
                                                </select>
                                            </div>
                                            ...
                                            <!--<div class="form-group">
                                                ...
                                                <input autocomplete="OFF" type="text" class="form-control form_datetime" name="start_time" value="<?php echo e(old('start_time')); ?>" />
                                            </div>-->
                                            
                                            <div class="form-group">
                                                <label>Color Code</label>
                                                <input autocomplete="OFF" type="text" class="form-control" name="color_code" value="<?php echo e(old('color_code')); ?>" />
                                            </div>
                                                    ...
                                                    <div class="tabbable tabs-left">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane <?php if($key==0): ?> active <?php endif; ?>" id="product_<?=$languages->languages_id?>">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control" name="package_title_<?php echo e($languages->languages_id); ?>" value="" />
                                                                </div>
                                                                <div class="form-group">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/current/resources/views/admin/collections/add.blade.php ENDPATH**/ ?>